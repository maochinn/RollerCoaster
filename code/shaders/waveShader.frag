...
void main()
{
    ...
    vec3 I = f_in.pos - u_view_pos;
    I.y *= -1.0f; //?
    vec3 R = reflect(I, f_in.normal);
    
    vec3 reflect_color = vec3(texture(u_cubemap, R));
    ...
    //shadow = 1.0f;
    reflect_color = (1.0f - shadow)*reflect_color;    

    f_color = vec4(reflect_color, 1.0f);
